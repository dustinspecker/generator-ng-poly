...
Generator.prototype.writing = function writing() {
  ...
  this.template('_service.js', path.join('src', this.module, config.lowerCamel + 'Service.js'), config);
  this.template('_spec.' + config.testScript,
    path.join('src', this.module, config.lowerCamel + 'Service_test.' + config.testScript), config);
};