...
export default {
  ...
  async findModuleFile(modulePath) {
    ...
    if (moduleFile.indexOf('-module') === -1) {
      console.log(chalk.red('Module file names without a `-module` prefix are deprecated. Official support will be dropped in v0.12.0. Add a `-module` prefix to be officially supported.'));
    }
  ...
  async findRoutesFile(routesPath) {
    ...
    if (routesFile.indexOf('-routes') === -1) {
      console.log(chalk.red('Routes file names without a `-routes` prefix are deprecated. Official support will be dropped in v0.12.0. Add a `-routes` prefix to be officially supported.'));
    }
