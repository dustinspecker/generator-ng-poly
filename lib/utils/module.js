 ...
 */
exports.getYoPath = function getYoPath() {
  return path.dirname(findUp.sync('.yo-rc.json'));
};

/**
 * Returns app directory without trailing / or \
 * @returns {String} - app directory
 */
exports.getAppDir = function () {
  let appDir = require(path.join(exports.getYoPath(), 'build.config.js')).appDir
    , lastCharacterInPath = appDir[appDir.length - 1];

  if (lastCharacterInPath === '/' || lastCharacterInPath === '\\') {
    return appDir.slice(0, appDir.length - 1);
  }
 ...
 */
exports.extractModuleNames = function (modulePath) {
  let appName;
  // return appName for app.js
  if (modulePath === exports.getAppDir()) {
    appName = require(path.join(exports.getYoPath(), 'package.json')).name;
    return [appName, null];
  }
 ...
 */
exports.normalizeModulePath = function (modulePath) {
  if (modulePath === exports.getAppDir()) {
    return '';
  }
 ...
 */
exports.moduleExists = function (modulePath) {
 ...
 * @return {String} - file path
 */
exports.findRoutesFile = function (routesPath) {
 ...
 * @return {String} - file path
 */
exports.findModuleFile = function (modulePath) {
 ...
 */
exports.moduleFilter = function (files) {
