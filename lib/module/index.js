  ...
  get writing() {
    return function () {
      ...
      this.getConfig().then(config => {
        ...
        this.context.modulePath = normalizeModulePath;

        // create new module directory
        return pify(mkdirp)(path.join(this.context.appDir, this.context.modulePath));
      }).then(() => {
        ...
        // get module path
        return utils.findModuleFile(filePathToCheck);
      }).then(foundFilePath => {
        ...
        return pify(fs.writeFile)(filePath, ngAddDep(moduleFile, depName));
      }).then(() => {
        // create new module
