...
Generator.prototype.writing = function writing() {
  ...
  this.template('_value.js', path.join('src', this.module, config.lowerCamel + 'Value.js'), config);
  this.template('_spec.' + config.testScript,
    path.join('src', this.module, config.lowerCamel + 'Value_test.' + config.testScript), config);
};